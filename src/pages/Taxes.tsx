...
export default function Taxes() {
    ...
    const handleBulkDelete = () => executeBulkAction(
        ...
        "Impostos excluídos com sucesso!",
        "Erro ao excluir impostos",
        `Tem certeza que deseja excluir ${selectedCount} impostos?`
    );
    ...
    const handleBulkComplete = () => executeBulkAction(
        ...
        "Impostos concluídos com sucesso!",
        "Erro ao concluir impostos"
    );
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <PageHeader
                title="Impostos"
                description={`Gerencie seus impostos (${totalCount} registros)`}
