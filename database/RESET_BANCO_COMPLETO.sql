...
-- Use apenas se tiver certeza que quer começar do zero.
-- ============================================================================
...
ALTER TABLE IF EXISTS public.obligations DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.installments DISABLE ROW LEVEL SECURITY;
...
DROP FUNCTION IF EXISTS public.create_installments_for_obligation(UUID, INTEGER, NUMERIC, DATE, TEXT);
...
-- ==========================
-- PASSO 4: RLS (Row Level Security)
-- ==========================
...
-- Função para gerar obrigações mensais
...
-- ============================================================================
-- ✅ PRONTO! Banco de dados limpo e reconstruído!
-- ============================================================================
